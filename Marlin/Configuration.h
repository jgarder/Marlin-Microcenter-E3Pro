...
#define STRING_CONFIG_H_AUTHOR "(Jgarder, Awesome Ender 3 Bro)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Awesome Ender-3 Pro V2.0"
...
#define HEATER_0_MAXTEMP 300 //all metal hotend on greys ender goes up to 300C (in theory)
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp  262.3
  #define DEFAULT_bedKi   46.17
  #define DEFAULT_bedKd 993.1
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.250 // (mm) Distance from real junction edge
 ...
 */
//#define Z_MIN_PROBE_PIN PB1 //PIN PB1 (v4.2.2 board BLTouch 5pin header) // 17 // Creality V4.2.7 BLTouch OUT (written on the board)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41, -6.0, -4.050 }
